...
#################################################################################
{
  ...
  "summary"              :  "Create and apply instant discount on POS order lines directly during the running POS session with the module.",
  "category"             :  "Point of Sale",
  "version"              :  "1.0",
  "author"               :  "Webkul Software Pvt. Ltd.",
  "license"              :  "Other proprietary",
  "website"              :  "https://store.webkul.com/Odoo-POS-Custom-Discount.html",
  "description"          :  """Odoo POS Custom Discount
...
POS create discount""",
  "live_test_url"        :  "http://odoodemo.webkul.com/?module=pos_custom_discounts",
